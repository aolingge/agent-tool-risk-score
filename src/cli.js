...
function usage() {
  console.log(`agent-tool-risk-score v${VERSION}

Usage:
  agent-tool-risk-score --path FILE_OR_DIR
  agent-tool-risk-score FILE_OR_DIR --markdown
  agent-tool-risk-score FILE_OR_DIR --sarif > results.sarif
  agent-tool-risk-score FILE_OR_DIR --annotations
  agent-tool-risk-score FILE_OR_DIR --redact
...
try {
  ...
  console.error(`agent-tool-risk-score: ${error.message}`);
  process.exit(2);
}
